...
public class SkillsEndpointUpdateCustomerTest extends SkillsEndpointTest {
	@Test
	public void shouldReturn201WhenSuccessfulForUpdateSkillRequest() throws Exception {
...
//	}
	...
	protected MockHttpServletRequestBuilder createRequestBuilder() {
		return put("/employeeSkills/{employeeId}/skills", employeeId);
	}
